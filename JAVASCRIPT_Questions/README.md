...
![BADGE](https://img.shields.io/badge/JAVASCRIPT--QUESTIONS-PROJECT-lightgrey)
...
![BADGE](https://img.shields.io/badge/HTML--CSS-JAVASCRIPT-lightgrey)

>![BADGE](https://img.shields.io/badge/MADE%20WITH%20FUN%20BY-BRIJESH%20VADALIA-blue)


![Gif](https://miro.medium.com/v2/resize:fit:3200/0*de0IdiUSoJTwgsys.gif)

> # All About `JAVASCRIPT INTERVIEW QUESTIONS` 😎

# **Gained expertise through this project :**

- I have learned all necessary things which are required to master Javascript. 


## __In short this project mainly focuses on JAVASCRIPT IMPORTANT QUESTIONS__
